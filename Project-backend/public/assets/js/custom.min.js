$(document).ready(function () {
    ...
    $(function () {
        $(".preloader").fadeOut();
        if (document.getElementById('side-menu')) { $("#side-menu").metisMenu(); }
    }),
        ...
        $(function () {
            var i = function () {
                ...
                768 > l ? ($("div.navbar-collapse").addClass("collapse"), (i = 100)) : $("div.navbar-collapse").removeClass("collapse"),
                    1170 > l ? (e.addClass("content-wrapper"), $(".sidebar-nav, .slimScrollDiv").css("overflow-x", "visible").parent().css("overflow", "visible")) : e.removeClass("content-wrapper"),
                    (s -= i),
                    1 > s && (s = 1),
        ...
        (function (e, i, l) {
            ...
            e(s).each(function () {
                var i = { toggle: !1 },
                    ...
                    n = e(this).children("i");
                s.length || ((s = l.children(".panel-heading").nextAll().wrapAll("<div/>").parent().addClass("panel-wrapper")), (i = {})),
                    s
                        .collapse(i)
        ...
        $(".slimscrollsidebar").slimScroll({ height: "100%", position: "right", size: "6px", color: "rgba(0,0,0,0.3)" }),
        $(".chat-list").slimScroll({ height: "100%", position: "right", size: "0px", color: "#dcdcdc" }),
        e.trigger("resize"),
